...
return array(
    ...
    // Comment the following to use a sqlite database
		...
		*/
		...
		'dbforum'=>array(
      'class'=>'CDbConnection',
			'connectionString' => 'mysql:host=localhost;dbname=4834_forum',
			'emulatePrepare' => true,
			'username' => '4834_vanilla',
			'password' => '8zzDZ145zE6!',
			'charset' => 'utf8',
			'tablePrefix' => 'vanilla_',
		),
		'dbblog'=>array(
      'class'=>'CDbConnection',
			'connectionString' => 'mysql:host=localhost;dbname=4834_wpblog',
			'emulatePrepare' => true,
			'username' => '4834_blog',
      'password' => 'tG!6YhuA',
			'charset' => 'utf8',
