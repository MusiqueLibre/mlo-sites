...
<article <?php sempress_post_id(); ?> class="index_list_columns two_columns masonry_item titlization" <?php sempress_blog_itemprop("blogPost"); ?> itemscope itemtype="http://schema.org/BlogPosting">
